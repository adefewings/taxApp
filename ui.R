...
ui <- fluidPage(
  ...
  fluidRow(
    ...
    column(6,
           ...
           tags$div(style = "font-size: 16px;",htmlOutput("main_app_intro")),
           div(style = "height: 30px;", p("")),
           
           #add the contional toggle:
           div(class = "switch-label",
               switchInput(inputId = "show_tabs_toggle", label = "Make Changes", value = FALSE)
           ),
           
           conditionalPanel(
             condition = "input.show_tabs_toggle == true",
             tabsetPanel(
               id = "tabs",
               ###################################
               #income taxes tab                 #  
               ...
               tabPanel(textOutput("income_tax"), value = "incomeTab",
                        tags$div(style = "font-size: 16px;",htmlOutput("income_tax_intro")),
                        ...
                        fluidRow(
                          ...
                          column(11,
                                 tags$div(style = "background-color: #C50031; height: 2px; width: 100%;margin-top: 10px; margin-left: 20px;margin-right:20px; padding: 0;"),
                                 )
                        ),
               ...
               tabPanel(textOutput("local_taxes_tab_label"), value = "councilTax",
                        tags$div(style = "font-size: 16px;",htmlOutput("local_taxes_tab_intro")),
                        tags$div(style = "background-color: #C50031; height: 2px; width: 100%; margin: 10px 0; padding: 0;"),
               ...
               #Other taxes tab                  #  
               ###################################
               tabPanel(textOutput("other_taxes_tab_label"), value = "otherTax",
                       #tags$div(style = "font-size: 16px;",htmlOutput("local_taxes_tab_intro")),

                        tags$div(style = "font-size: 16px;",htmlOutput("other_taxes_intro")),
                        div(style = "height: 20px;", p("")),
                        tags$div(style = "background-color: #C50031; height: 2px; width: 100%; margin: 10px 0; padding: 0;"),
  ...
  jqui_resizable(
    ...
    column(6,
           fluidRow(
             tags$div(style = "font-size: 18px; text-align: center;margin-top: 20px",textOutput("piechart_title"))
           ),    
           ...
           div(class = "switch-label",
               switchInput(inputId = "show_tax_data_toggle", label = "Show Tax Breakdown", value = FALSE)
           ),
           #actionButton("show_tax_data_button","See Data:"),
           conditionalPanel(
             #condition = "input.show_tax_data_button % 2 == 1",
             condition = "input.show_tax_data_toggle == true",
             fluidRow(
               #div(style = "height: 21px;", p("")),
               div(style = "height:5px",p("")),
               div(style = "display: flex; justify-content: center;",
                   tableOutput("tax_table1")
               )
             )
           ),
